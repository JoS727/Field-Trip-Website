...
.menu-toggle { display: none; width: 46px; height: 46px; border: 1px solid var(--border); border-radius: 999px; background: rgba(255,255,255,0.72); align-items: center; justify-content: center; flex-direction: column; gap: 4px; padding: 0; cursor: pointer; flex: 0 0 auto; }
...
@media (max-width: 900px) {
  ...
  .nav { display: none; width: 100%; flex-direction: column; gap: 0.35rem; padding: 0.75rem 0 0.25rem; margin-top: 0.15rem; border-top: 1px solid rgba(21,50,77,0.08); }
...
@media (max-width: 640px) {
  ...
  .button { width: 100%; }
  .topbar__inner { padding: 0.72rem 0; gap: 0.75rem; }
